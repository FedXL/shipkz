...
from legacy.models import Users as TelegramUser, WebUsers
...
class Profile(models.Model):
    ...
    telegram_user = models.ForeignKey(TelegramUser, on_delete=models.CASCADE, blank=True, null=True, related_name='profile')
