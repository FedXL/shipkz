...
//                 document.cookie = 'ShipKZAuthorization=911; expires=Thu, 01 Jan 1971 00:00:00 UTC; path=/;';
//             }
//             function getToken() {
...
//                 token = getToken();
//                 if (token !== false) {
//                     theWay = 'get_access_token';
//                 }
//                 else {
//                     theWay = 'get_long_token';
//                 }
//                 actionBody = `action=unregistered_user&event=${theWay}&long_token=${token}`;
...
//                     .then(data => {
//                         if (theWay === "get_long_token" && data.result === 'success' && infiniteLoop === false ){
//                             const longTokenValue = data.long_token;
//                             const expiresDate = new Date();
//                             expiresDate.setDate(expiresDate.getDate() + 7);
//                             document.cookie = `ShipKZAuthorization=${longTokenValue}; path=/; expires=${expiresDate.toUTCString()};`;
//                             unregisteredWssConnect(event);
//                             infiniteLoop = true;
//                         } else if (theWay === "get_access_token" && data.result === 'success' ) {
//                             const accessToken = data.access_token;
//                             const userLogin = data.user_name;
//                             const socketUrl = "wss://supportstation.kz/ws/";
//                             clickButton.style.display = 'none';
//                             let messanger_container = document.getElementById('chatMainContainer');
//                             messanger_container.style.display = 'block';
//                             const ws = initWssConnection(accessToken, socketUrl);
//                             addEventListenersToChatConstructions(userLogin, ws);
//                         } else if (theWay === "get_access_token" && data.result ==='invalid_long_token') {
//                             deleteToken();
//                             unregisteredWssConnect(event);
//                         } else if (data === '0') {
//                             console.log('ajax was not created we need to relaod page')
//                         }
//                     })
//                     .catch(error => {
...
//                 return false;
//             }
//             const haveTokenOrNot = getCookie()
//             console.log('long token is');
//             console.log(haveTokenOrNot);
//             console.log('we try to get cookie -----!');
//             if (haveTokenOrNot) {
//                 console.log('we have a cookie -----!');
//                 let closeButtonHandle = document.getElementById('closeCustomButton');
//                 closeButtonHandle.addEventListener('click',function () {
//                     let messagesCounter = document.getElementById('UnreadMessagesCounter2');
//                     let messageButton = document.getElementById('messengerMiniButton2');
...
//                 });
//
//                 let actionBody = `action=unregistered_user&event=get_access_token&long_token=${haveTokenOrNot}`;
//                 const promise2 = fetch('<?php echo $ajax_url; ?>', {
//                     method: 'POST',
//                     headers: {
//                         'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
//                     },
...
//                             console.log('we have access token, go go ws2!');
//                             const accessToken = data.access_token;
//                             const url = '<?php echo $wssUnreg;?>';
//                             console.log(accessToken);
//                             console.log(url);
//                             initWssConnectionUnread(accessToken, url);
//                         } else {
//                             console.error('Promise 2 was unsuccessful');
//                             console.error(data);
//                         }
//                     })
//                     .catch(error => {
...
//         $message_count = unread_messages_counter();
//         $current_user_id = get_current_user_id();
//         $wss2 = get_menu_wss();
...
//
// function startMain() {
//     const menu = document.getElementById('messengerMiniButton');
//     if (menu) {
//         console.log('start main function');
//         main();
//     } else {
//         console.log('cant find menu');
//         setTimeout(startMain, 200);
//     }
// }
//
// const main = () => {
...
//     const wssUrl = '<?php echo $wss2; ?>';
//     initWssConnectionUnread(token, wssUrl);
//     let messageButton = document.getElementById('messengerMiniButton');
//
//     const messageCount = <?php echo json_encode($message_count);
//     const UnreadCount = messageCount.data.unreadCount;
//
//     if (UnreadCount > 0 ) {
//         console.log(UnreadCount);
//         const messagesCounter = createSquareCounter(UnreadCount,'UnreadMessagesCounter');
//         messageButton.appendChild(messagesCounter);
//         messageButton.classList.add('createSignal');
//         messagesCounter.classList.add('createSignal');
//     }
